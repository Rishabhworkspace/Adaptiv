    ...
    return (
        <section id="why-me" className="py-20 scroll-mt-20">
            ...
            <GlassCard elevated className="relative overflow-hidden group border-[#6c5ce7]/30">
                ...
                <h3 className="text-2xl font-bold mb-6 text-primary">{whyMe.title}</h3>

                <ul className="mb-8 space-y-4">
                    {whyMe.points.map((point, i) => (
                        <li key={i} className="text-secondary flex items-start gap-4">
                ...
                <div className="p-4 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 rounded-lg mb-8">
